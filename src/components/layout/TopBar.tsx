    ...
    <header className="sticky top-0 z-30 border-b border-border bg-background/85 backdrop-blur-xl">
      ...
      <div className="h-14 flex items-center gap-3 px-5">
        ...
        <div className="flex items-center gap-1 ml-auto">
          <Button variant="ghost" size="icon" title="Achievement alerts" aria-label="Achievement alerts" className="relative">
          ...
          <Button variant="ghost" size="icon" title="AI Assistant" aria-label="AI Assistant">
            <Sparkles className="h-4 w-4 text-trophy" />
          </Button>
          <Button variant="ghost" size="icon" title="Quick actions" aria-label="Quick actions">
