...
function Page() {
  return (
    <EngineDashboard
      ...
      rows={[
        { id: "r1", name: <div className="flex items-center gap-2"><Crown className="h-4 w-4 text-accent-amber" /><span className="font-medium">Grandmaster</span></div>, role: "Developer", min: "80", holders: "12", status: <StatusChip tone="success">Active</StatusChip> },
